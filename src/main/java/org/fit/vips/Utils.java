...
public class Utils {
	...
	private static void createCollapsableTree(Document htmlDoc, Element htmlBody) {		
		...
		treeScript.setTextContent("$(function () { " +
	...
	private static Element createHtmlListItemElement(Element xmlNode, Document htmlDoc) {
        ...
        liNode.setAttribute("style",
            "background-color:" + xmlNode.getAttribute("BgColor") + ";" +
            "font-size:" + xmlNode.getAttribute("FontSize") + ";" +
            "font-weight:" + xmlNode.getAttribute("FontWeight") + ";" +
            "border: 1px solid black;" +
            "padding: 10px"            
		);
		liNode.setAttribute("EvincedId", xmlNode.getAttribute("EvincedId"));
		liNode.setTextContent(
			xmlNode.getAttribute("ID") + ". EvincedIDs: " + xmlNode.getAttribute("EvincedId") + "Content: " + xmlNode.getAttribute("Content") );
		return liNode;
	}
